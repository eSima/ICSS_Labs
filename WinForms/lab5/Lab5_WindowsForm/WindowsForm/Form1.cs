...
namespace WindowsForm
{
    public partial class Form1 : Form
    {
        ...
        private void NewDocument()
        {
            ...
            firstTable.Borders.Enable = 1; foreach (WordObj.Row row in firstTable.Rows)
            {
                ...
                {          //Заголовок таблицы          
                    if (cell.RowIndex == 1)
                    {
                        ...
                        cell.VerticalAlignment = WordObj.WdCellVerticalAlignment.wdCellAlignVerticalCenter;
